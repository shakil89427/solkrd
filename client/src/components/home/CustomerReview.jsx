...
const CustomarReview = () => {
  ...
  return (
    <div className="mt-5 select-none bg-amber-900 p-5 lg:pt-12 pb-16 rounded-lg">
      ...
      <div className="flex items-center justify-center">
        <IoMdArrowDropleft
          ...
          className="cursor-pointer shrink-0 text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl"
        />
        <Swiper
          effect={"coverflow"}
          centeredSlides={true}
          ...
          {new Array(12).fill("").map((item, index) => (
            <SwiperSlide key={index} className="bg-white p-5 rounded-xl overflow-hidden">
              ...
              <p className="text-sm mt-3">
                ...
                blanditiis est? Numquam accusamus, vero vitae facere veritatis beatae dolor ratione
                delectus earum...
              </p>
            </SwiperSlide>
          ))}
