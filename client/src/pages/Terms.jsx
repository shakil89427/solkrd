      ...
      <div className="container">
        ...
        >
          ...
          <p className="p-5 mt-5 bg-white text-gray-700 rounded-lg text-lg max-w-[1200px] mx-auto">
            ...
            porro et. Nihil tenetur quidem quis alias ipsum fugit explicabo qui, ratione,
            praesentium aut cum iure rem quo repellendus enim laborum necessitatibus doloremque!
            Unde, non sunt quasi esse ex ad ut necessitatibus, perferendis vero, harum dolorum
            voluptatum quibusdam eveniet quos. Distinctio cum saepe tempora tempore soluta, sapiente
            magnam perferendis fuga labore incidunt illo itaque non tenetur ullam dolores quod
            repellat exercitationem esse nesciunt veniam ex. Ex, impedit ut consequuntur, fugiat
            architecto nulla deserunt exercitationem ratione dolores expedita.
          </p>
